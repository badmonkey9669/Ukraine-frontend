...
export interface FundUkraineInterface extends utils.Interface {
  ...
  functions: {
    ...
    "donateWithEth(uint8)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "GASMASK", values?: undefined): string;
  ...
  encodeFunctionData(
    functionFragment: "donateWithEth",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "GASMASK", data: BytesLike): Result;
...
export interface FundUkraine extends BaseContract {
  ...
  functions: {
    ...
    GASMASK(overrides?: CallOverrides): Promise<[number]>;
  ...
  estimateGas: {
    ...
    GASMASK(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    GASMASK(overrides?: CallOverrides): Promise<PopulatedTransaction>;
